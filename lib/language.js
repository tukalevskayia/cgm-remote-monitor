...
function init() {
  ...
  var translations = {
    ...
    ,'temp basals must be rendered to display this report': { //hourlystats.js
      ...
      ,ru: 'ВБС должны быть показаны для отображения этого отчета'
    ...
    ,'There is not sufficient data to run this report. Select more days.' : {
      ...
      ,ru: 'Недостаточно данных для выполнения этого отчета. Выберите больше дней.'
    ...
    ,'Using stored API secret hash' : {
      ...
      ,ru: 'Использование сохраненного хеша API secret'
    ...
    ,'No API secret hash stored yet. You need to enter API secret.' : {
      ...
      ,ru: 'Хеша API secret еще нет в памяти. Введите API secret.'
    ...
    ,'Your API secret must be at least 12 characters long' : {
      ...
      ,ru: 'Ваш API secret должен быть не короче 12 символов'
    ...
    ,'Remember this device. (Do not enable this on public computers.)' : {
      ...
      ,ru: 'Запомнить это устройство. (Не включайте это на общедоступных компьютерах.)'
      }
    ,'Treatments' : {
      cs: 'Ošetření'
      ,de: 'Behandlungen'
    ...
    ,'Please verify that the data entered is correct' : {
      ...
      ,ru: 'Пожалуйста, убедитесь, что введенные данные верны'
    ...
    ,'Use BG correction in calculation' : {
      ...
      ,ru: 'Учитывать коррекцию ГК при расчете'
    ...
    ,'Use carbs correction in calculation' : {
      ...
      ,ru: 'Учитывать углеводы при расчете'
    ...
    ,'Enter insulin correction in treatment' : {
      ...
      ,ru: 'Добавить инсулин в запись терапии'
    ...
    ,'Carbs needed if Insulin total is negative value' : {
      ...
      ,ru: 'Требуются углеводы, если суммарный инсулин отицательный'
    ...
    ,'Device authenticated' : {
      ...
      ,ru: 'Устройство аутентифицировано'
    ...
    ,'Device not authenticated' : {
      ...
      ,ru: 'Устройство не аутентифицировано'
    ...
    ,'Your device is not authenticated yet' : {
      ...
      ,ru: 'Ваше устройство еще не аутентифицировано'
    ...
    ,'Bolus Wizard Preview' : {
      ...
      ,pt: 'Ajuda de bolus'
      ,ru: 'Предпросмотр калькулятора болюса (BWP)'
      ,sk: 'Bolus Wizard'
    ...
    ,'Insulin Cartridge Change' : {
      ...
      ,ru: 'Замена резервуара с инсулином'
      ,sk: 'Výmena inzulínu'
    ...
    ,'View all treatments' : {
      ...
      ,ru: 'Показать все события терапии'
    ...
    ,'Pump Battery Low Alarm' : {
      ...
      ,hr: 'Upozorenje slabe baterije pumpe'
       ...
       ,ru: 'Низкий уровень заряда помпы'
    ...
    ,'Pump Battery change overdue!' : {  // batteryage.js
      ...
      , pl: 'Bateria pompy musi być wymieniona!'
       ,ru: 'Пропущена замена батареи помпы!'
    ...
    ,'When enabled an alarm may sound.' : {
      ...
      ,ru: 'При включении сигналы будут слышны.'
    ...
    ,'When enabled the page will be dimmed from 10pm - 6am.' : {
      ...
      ,ru: 'При включении страница затемнена в 22:00 - 06:00.'
    ...
    ,'When enabled small white dots will be displayed for raw BG data' : {
      ...
      ,ru: 'При включении маленькие белые точки будут отображаться для сырых данных ГК'
    ...
    ,'Colorblind-friendly colors' : {
      ...
      ,ru: 'Дальтоник-дружественные цвета'
      }
    ...
    ,'Alarm Test / Smartphone Enable' : {
      ...
      ,ru: 'Тест тревог / Смартфон включен'
      ,sk: 'Test alarmu'
    ...
    ,'Remove future items from mongo database' : {
      ...
      ,ru: 'Удалить записи в будущем из базы данных mongo'
    ...
    ,'Find and remove treatments in the future' : {
      ...
      ,ru: 'Найти и удалить события терапии в будущем'
    ...
    ,'This task find and remove treatments in the future.' : {
      ...
      ,ru: 'Эта опция находит и удаляет записи терапии в будущем.'
    ...
    ,'Remove treatments in the future' : {
      ...
      ,ru: 'Удалить записи терапии в будущем'
    ...
    ,'Find and remove entries in the future' : {
      ...
      ,ru: 'Найти и удалить записи в будущем'
    ...
    ,'This task find and remove CGM data in the future created by uploader with wrong date/time.' : {
      ...
      ,ru: 'Эта опция находит и удаляет данные CGM в будущем, созданные загрузчиком с неверными датой/временем.'
    ...
    ,'Clean Mongo status database' : {
      ...
      ,ru: 'Очистить базу данных статуса Mongo'
    ...
    ,'This task removes all documents from devicestatus collection. Useful when uploader battery status is not properly updated.' : {
      ...
      ,ru: 'Эта опция удаляет все документы из коллекции devicestatus. Полезно, когда состояние батвреи загрузчика не обновляется должным образом.'
    ...
    ,'Delete all documents from devicestatus collection older than 30 days' : {
      ...
      ,ru: 'Удалить все документы из коллекции devicestatus старше, чем 30 дней'
    ...
    ,'This task removes all documents from devicestatus collection that are older than 30 days. Useful when uploader battery status is not properly updated.' : {
      ...
      ,ru: 'Эта опция удаляет все документы старше, чем 30 дней, из коллекции devicestatus. Полезно, когда состояние батвреи загрузчика не обновляется должным образом.'
    ...
    ,'Delete old documents from devicestatus collection?' : {
      ...
      ,ru: 'Удалить старые документы из коллекции devicestatus?'
    ...
    ,'Clean Mongo entries (glucose entries) database' : {
      ...
      ,ru: 'Очистить базу данных записей (записей глюкозы) Mongo'
    ...
    ,'Delete all documents from entries collection older than 180 days' : {
      ...
      ,ru: 'Удалить все документы из коллекции entries старше, чем 180 дней'
    ...
    ,'This task removes all documents from entries collection that are older than 180 days. Useful when uploader battery status is not properly updated.' : {
      ...
      ,ru: 'Эта опция удаляет все документы старше, чем 180 дней, из коллекции entries. Полезно, когда состояние батвреи загрузчика не обновляется должным образом.'
    ...
    ,'Delete old documents from entries collection?' : {
      hr: 'Obriši stare zapise?'
      ,ru: 'Удалить старые документы из коллекции entries?'
    ...
    ,'%1 is not a valid number' : {
      ...
      ,ru: '%1 не является действительным числом'
    ...
    ,'%1 is not a valid number - must be more than 2' : {
      ...
      ,ru: '%1 не является действительным числом - должно быть больше 2'
    ...
    ,'Clean Mongo treatments database' : {
      ...
      ,ru: 'Очистить базу данных терапии Mongo'
    ...
    ,'Delete all documents from treatments collection older than 180 days' : {
      ...
      ,ru: 'Удалить все документы из коллекции treatments старше, чем 180 дней'
    ...
    ,'This task removes all documents from treatments collection that are older than 180 days. Useful when uploader battery status is not properly updated.' : {
      ...
      ,ru: 'Эта опция удаляет все документы старше, чем 180 дней, из коллекции treatments. Полезно, когда состояние батвреи загрузчика не обновляется должным образом.'
    ...
    ,'Edit treatment' : {
      ...
      ,ru: 'Редактировать событие терапии'
    ...
    ,'Absolute basal value' : {
      ...
      ,ru: 'Абсолютная базальная скорость'
    ...
    ,'Save current record before changing to new?' : {
      ...
      ,ru: 'Сохранить текущую запись перед переходом к новой?'
    ...
    ,'Duration of Insulin Activity (DIA)' : {
      ...
      ,ru: 'Продолжительность действия инсулина (DIA)'
    ...
    ,'Represents the typical duration over which insulin takes effect.  Varies per patient and per insulin type. Typically 3-4 hours for most pumped insulin and most patients. Sometimes also called insulin lifetime.' : {
      ...
      ,ru: 'Представляет типичную продолжительность действия инсулина. Зависит от пациента и от типа инсулина. Обычно 3-4 часа для большинства инсулинов в помпах и большинства пациентов. Иногда также называется продолжительностью жизни инсулина.'
    ...
    ,'Insulin to carb ratio (I:C)' : {
      ...
      ,ru: 'Углеводный коэффициент (УК, CR, I:C)'
    ...
    ,'g carbs per U insulin. The ratio of how many grams of carbohydrates are offset by each U of insulin.' : {
      ...
      ,ru: 'г углеводов на ЕД инсулина. Отношение количества граммов углеводов, компенсируемых каждой ЕД инсулина.'
    ...
    ,'Insulin Sensitivity Factor (ISF)' : {
      ...
      ,ru: 'Фактор чувствительности к инсулину (ФЧИ, КЧ, ISF)'
    ...
    ,'mg/dL or mmol/L per U insulin. The ratio of how much BG changes with each U of corrective insulin.' : {
      ...
      ,ru: 'мг/дл или ммоль/л на ЕД инсулина. Отношение, насколько сильно ГК меняется с каждой единицей корректирующего инсулина.'
    ...
    ,'Carbs activity / absorption rate' : {
      ...
      ,ru: 'Активность углеводов / скорость абсорбции'
    ...
    ,'grams peUr unit time. Represents both the change in COB per unit of time, as well as the amount of carbs that should take effect over that time.  Carb absorption / activity curves are less well understood than insulin activity, but can be approximated using an initial delay followed by a constant rate of absorption (g/hr).' : {
      ...
      ,ru: 'грамм на ед времени. Представляет изменение COB за единицу времени, a также количество углеводов, которые должны подействовать за это время. Кривые абсорбции / активности углеводов менее понятны, чем активность инсулина, но могу быть прикинуты, используя начальную задержку, за которой следует постоянная скорость абсорбции (г/ч.).'
    ...
    ,'Target BG range [mg/dL,mmol/L]' : {
      ...
      ,ru: 'Целевой диапазон ГК [мг/дл, ммоль/л]'
    ...
    ,'Start of record validity' : {
      ...
      ,ru: 'Начало срока действия записи'
    ...
    ,'Default values used.' : {
      ...
      ,ru: 'Использованы значения по умолчанию.'
    ...
    ,'Error. Default values used.' : {
      ...
      ,ru: 'Ошибка. Использованы значения по умолчанию'
    ...
    ,'Time ranges of target_low and target_high don\'t  match. Values are restored to defaults.' : {
      ...
      ,ru: 'Диапазоны времени target_low и target_high не совпадают. Восстановлены значения по умолчанию.'
    ...
    ,'When enabled icon to start edit mode is visible' : {
      ...
      ,ru: 'При включении кнопка перехода в режим редактирования становится видимой'
    ...
    ,'Change treatment time to %1 ?' : {
      ...
      ,ru: 'Изменить время события терапии на %1?'
    ...
    ,'Change carbs time to %1 ?' : {
      ...
      ,ru: 'Изменить время углеводов на %1?'
    ...
    ,'Change insulin time to %1 ?' : {
      ...
      ,ru: 'Изменить время инсулина на  %1?'
    ...
    ,'Remove insulin from treatment ?' : {
      ...
      ,ru: 'Удалить инсулин из события терапии?'
    ...
    ,'Remove carbs from treatment ?' : {
      ...
      ,ru: 'Удалить углеводы из события терапии?'
    ...
    ,'Loading profile switch data' : {
      ...
      ,ru: 'Загрузка данных переключения профиля'
    ...
    ,'Redirecting you to the Profile Editor to create a new profile.' : {
      ...
      ,ru: 'Переход к Редактору профиля для создания нового профиля.'
    ...
    ,'Base basal insulin:' : {
      ...
      ,ru: 'Стандартный базальный инсулин'
      ,sv: 'Basalinsulin:'
      ,nb: 'Basalinsulin:'
      ,hr: 'Osnovni bazal:'
      ,ko: '기본 basal 인슐린'
    ...
    ,'Positive temp basal insulin:' : {
      ...
      ,ru: 'Инсулин от положительных ВБС '
    ...
    ,'Negative temp basal insulin:' : {
      ...
      ,ru: 'Инсулин от отрицательных ВБС'
    ...
    ,'Roles - Groups of People, Devices, etc' : {
      ...
      ,ru: 'Роли - группы людей, устройств и т. д.'
    ...
    ,'Subjects - People, Devices, etc' : {
      ...
      ,ru: 'Субъекты - люди, устройства и т. д.'
    ...
    ,'Each subject will have a unique access token and 1 or more roles.  Click on the access token to open a new view with the selected subject, this secret link can then be shared.' : {
      ...
      ,ru: 'Каждый субъект будет иметь уникальный код доступа и 1 или более ролей. Нажмите на иконку кода доступа, чтобы открыть новое окно с выбранным субъектом, эту секретную ссылку после этого можно переслать.'
    ...
    ,'Active temp basal duration' : {
      ...
      ,ru: 'Продолжительность текущей ВБС'
    ...
    ,'Basal profile value' : {
      ...
      ,ru: 'Стандартный базал в профиле'
      ,fr: 'Valeur du débit basal'
    ...
    ,'Active combo bolus' : {
      ...
      ,ru: 'Активный болюс двойной волны'
      ,sv: 'Aktiv kombobolus'
      ,nb: 'Kombinasjonsbolus'
    ...
    ,'Active combo bolus start' : {
      ...
      ,ru: 'Активный болюс двойной волны начат'
    ...
    ,'Active combo bolus duration' : {
      ...
      ,ru: 'Продолжительность активного болюса двойной волны'
    ...
    ,'Active combo bolus remaining' : {
      ...
      ,ru: 'Осталось активного болюса двойной волны'
    ...
    ,'Snoozing high alarm since there is enough IOB' : {
      ...
      ,ru: 'Откладывание предупреждения о высокой ГК, т.к. достаточно IOB'
    ...
    ,'Check BG, time to bolus?' : {
      ...
      ,ru: 'Проверьте ГК, пора ввести болюс?'
    ...
    ,'Excess insulin equivalent %1U more than needed to reach low target, not accounting for carbs' : {
      ...
      ,ru: 'Избыток инсулина: на %1ЕД больше, чем необходимо для достижения нижней цели, не учитывая углеводы'
    ...
    ,'Excess insulin equivalent %1U more than needed to reach low target, MAKE SURE IOB IS COVERED BY CARBS' : {
      ...
      ,ru: 'Избыток инсулина: на %1ЕД больше, чем необходимо для достижения нижней цели, УБЕДИТЕСЬ, ЧТО IOB ПОКРЫТ УГЛЕВОДАМИ'
    ...
    ,'%1U reduction needed in active insulin to reach low target, too much basal?' : {
      ...
      ,ru: 'Нужно убрать %1ЕД для достижения нижней цели, слишком много базала?'
    ...
    ,'basal adjustment out of range, give carbs?' : {
      ...
      ,ru: 'Корректировка базала вне диапазона, съешьте углеводы?'
    ...
    ,'basal adjustment out of range, give bolus?' : {
      ...
      ,ru: 'Корректировка базала вне диапазона, введите болюс?'
    ...
    ,'Check BG using glucometer before correcting!' : {
      ...
      ,ru: 'Проверьте ГК по глюкометру перед корректировкой!'
    ...
    ,'Basal reduction to account %1 units:' : {
      ...
      ,ru: 'Снизьте ВБС, чтобы получить эффект на %1 ЕД:'
   ...
   ,'Last Carbs' : {
    ...
    ,'Insulin reservoir change overdue!' : {
      ...
      ,ru: 'Пропущена замена резервуара с инсулином!'
    ...
    ,'Time to change insulin reservoir' : {
      ...
      ,ru: 'Пора заменить резервуар с инсулином'
    ...
    ,'Change insulin reservoir soon' : {
      ...
      ,ru: 'Скоро заменять резервуар с инсулином'
    ...
    ,'Insulin reservoir age %1 hours' : {
      ...
      ,ru: 'Возраст картриджа с инсулином %1 ч.'
    ...
    ,'Sensor change/restart overdue!' : {
      ...
      ,ru: 'Пропущена замена/перезапуск сенсора!'
    ...
    ,'Change/restart sensor soon' : {
      ...
      ,ru: 'Скоро заменять/перезапускать сенсор'
    ...
    ,'To see this report, press SHOW while in this view' : {
      ...
      ,ru: 'Чтобы увидеть этот отчет, нажмите ПОКАЗАТЬ, находясь в этом разделе'
    ...
    ,'This is only a rough estimation that can be very inaccurate and does not replace actual blood testing. The formula used is taken from:' : {
      ...
      ,ru: 'Это только приблизительная оценка, которая может быть очень неточной и не заменяет настоящий анализ крови. Используемая формула взята из:'
    ...
    , 'Time in fluctuation and Time in rapid fluctuation measure the % of time during the examined period, during which the blood glucose has been changing relatively fast or rapidly. Lower values are better.' : {
      ...
      ,ru: 'Время в колебаниях и Время в быстрых колебаниях измеряют % времени в течение исследуемого периода, в течение которого уровень глюкозы в крови изменялся относительно быстро или быстро. Чем ниже значения, тем лучше.'
    ...
    , 'Mean Total Daily Change is a sum of the absolute value of all glucose excursions for the examined period, divided by the number of days. Lower is better.' : {
      ...
      ,ru: 'Среднее совокупное дневное изменение представляет собой сумму абсолютных значений всех изменений глюкозы за исследуемый период, деленную на количество дней. Ниже - лучше.'
    ...
    , 'Mean Hourly Change is a sum of the absolute value of all glucose excursions for the examined period, divided by the number of hours in the period. Lower is better.' : {
      ...
      ,ru: 'Среднее совокупное часовое изменение представляет собой сумму абсолютных значений всех изменений глюкозы за исследуемый период, деленную на количество часов в периоде. Ниже - лучше.'
    ...
    , 'GVI (Glycemic Variability Index) and PGS (Patient Glycemic Status) are measures developed by Dexcom, detailed <a href="' : {
     ...
     ,ru: 'GVI (Glycemic Variability Index) и PGS (Patient Glycemic Status) больного – величины, разработанные Dexcom, подробнее <a href="'
    ...
    , 'Mean Total Daily Change' : {
      ...
      ,ru: 'Среднее совокупное дневное изменение'
    ...
    , 'Mean Hourly Change' : {
      ...
      ,ru: 'Среднее совокупное часовое изменение'
    ...
    'virtAsstUnknown': {
      ...
      , ru:  'В настоящий момент эта величина неизвестна. Зайдите на сайт Nightscout, чтобы узнать подробности.'
    ...
    'virtAsstBasal': {
        ...
        , ru:  '%1 текущий базал %2 единиц в час'
    ...
    'virtAsstBasalTemp': {
        ...
        , ru:  '%1 временная базальная скорость %2 единиц в час закончится в %3'
    ...
    'virtAsstIob': {
        ...
        , ru: 'и у вас %1 активного инсулина.'
    ...
    'virtAsstReservoir': {
      ...
      , ru: 'У вас осталось %1 единиц в резервуаре'
      , tr: '%1 birim kaldı'
    },
    'virtAsstPumpBattery': {
    ...
    'virtAsstLastLoop': {
      ...
      , ru: 'Последний успешный цикл был %1'
    ...
    'virtAsstLoopNotAvailable': {
      ...
      , ru: 'Модуль замкнутого конутра, кажется, выключен'
    ...
    'virtAsstLoopForecastAround': {
      ...
      , ru: 'По прогнозу замкнутого контура ожидается, что у вас будет примерно %1 за следующие %2'
    ...
    'virtAsstLoopForecastBetween': {
      ...
      , ru: 'По прогнозу замкнутого контура ожидается, что у вас будет между %1 и %2 за следующие %3'
    ...
    'virtAsstAR2ForecastAround': {
      ...
      , ru: 'По прогнозу AR2 ожидается, что у вас будет около %1 за следующие %2'
    ...
    'virtAsstForecastUnavailable': {
      ...
      , ru: 'При текущих данных прогноз невозможен'
    ...
    'virtAsstOpenAPSForecast': {
      ...
      , ru: 'Ожидаемая OpenAPS глюкоза в крови %1 '
    ...
    'Last entry {0} minutes ago': {
      ...
      , ru: 'Последняя запись {0} минут назад'
    ...
    'Database Size near its limits!': {
	  ...
	  ,ru: 'Размер базы данных приближается к ее ограничениям!'
    },
    'Database size is %1 MiB out of %2 MiB. Please backup and clean up database!': {
	  ...
	  ,ru: 'Размер базы данных на %1 Мб больше, чем %2 Мб. Пожалуйста, сохраните и очистите базу данных!'
    },
    'Database file size': {
      pl: 'Rozmiar pliku bazy danych'
      ,nl: 'Database bestandsgrootte'
	  ,ru: 'Размер файлов базы данных'
    },
    '%1 MiB of %2 MiB (%3%)': {
      pl: '%1 MiB z %2 MiB (%3%)'
    ...
    'virtAsstDatabaseSize': {
	  ...
	  ,ru: '%1 Мб, что составляет %2% от доступного размера базы данных'
    },
