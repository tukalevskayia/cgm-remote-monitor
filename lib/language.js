...
function init() {
  ...
  var translations = {
    ...
    ,'Store hash on this computer (Use only on private computers)' : {
      ...
      ,ru: 'Сохранить хеш на этом устройстве (только для личных устройств)'
    ...
    ,'Logarithmic (Dynamic)' : {
      ...
      ,ru: 'Логарифмическая (Динамическая)'
    ...
    ,'Bolus Wizard Preview' : {
      ...
      ,pt: 'Ajuda de bolus'
      ,ru: 'Предпросмотр помощника болюса (BWP)'
      ,sk: 'Bolus Wizard'
    ...
    ,'Change carbs time to %1 ?' : {
      ...
      ,ru: 'Изменить время углеводов на %?'
    ...
    ,'Profile is going to be saved in newer format used in Nightscout 0.9.0 and above and will not be usable in older versions anymore.\nAre you sure?' : {
      ...
      ,ru: 'Профиль будет сохранен в более новом формате, используемом в Nightscout 0.9.0 и выше и не сможет более использоваться в старых версиях.\nВы уверены?'
    ...
    ,'Wrong profile setting.\nNo profile defined to displayed time.\nRedirecting to profile editor to create new profile.' : {
      ...
      ,ru: 'Неверные настройки профиля.\nДля отображаемого времени не определен профиль.\nПереход к редактору профиля для создания нового профиля.'
    ...
    ,'Unable to delete Subject' : {
      ...
      ,ru: 'Невозможно удалить субъекта'
    ...
    ,'Active temp basal duration' : {
      ...
      ,ru: 'Продолжительность активной ВБС'
   ...
   ,'Last Carbs' : {
    ...
    'alexaLoopForecast': {
      ...
      , ru: 'По прогнозу замкнутого контура ожидается, что у вас будет $1 за последующие %2'
    ...
    en: 'Your raw bg is %1'
      ...
      , ru: 'Ваш сырая глюкоза в крови $1'
